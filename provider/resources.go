...
func Provider() tfbridge.ProviderInfo {
	...
	prov := tfbridge.ProviderInfo{
		...
		Resources:            map[string]*tfbridge.ResourceInfo{
			...
			"nsxt_policy_user_management_role": {Tok: makeResource(mainMod, "nsxt_policy_user_management_role")},
			"nsxt_policy_user_management_role_binding": {Tok: makeResource(mainMod, "nsxt_policy_user_management_role_binding")},
			...
			"nsxt_policy_uplink_host_switch_profile": {Tok: makeResource(mainMod, "nsxt_policy_uplink_host_switch_profile")},
			"nsxt_node_user": {Tok: makeResource(mainMod, "nsxt_node_user")},
			...
			"nsxt_policy_host_transport_node": {Tok: makeResource(mainMod, "nsxt_policy_host_transport_node")},
			"nsxt_edge_high_availability_profile": {Tok: makeResource(mainMod, "nsxt_edge_high_availability_profile")},
			"nsxt_policy_host_transport_node_collection": {Tok: makeResource(mainMod, "nsxt_policy_host_transport_node_collection")},
		},
		DataSources: map[string]*tfbridge.DataSourceInfo{
			...
			"nsxt_policy_uplink_host_switch_profile": {Tok: makeDataSource(mainMod, "nsxt_policy_uplink_host_switch_profile")},
			...
			"nsxt_compute_manager_realization": {Tok: makeDataSource(mainMod, "nsxt_compute_manager_realization")},
